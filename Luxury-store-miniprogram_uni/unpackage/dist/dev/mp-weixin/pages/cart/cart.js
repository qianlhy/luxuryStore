...
var _cart = _interopRequireDefault(__webpack_require__(/*! ./pages/cart/cart.vue */ 80));
// @ts-ignore
...
/* harmony import */ var _cart_vue_vue_type_template_id_0f00adf4___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cart.vue?vue&type=template&id=0f00adf4& */ 81);
  ...
  methods: {
    ...
    getCartData: function getCartData() {
      ...
      cartApi.getCartList().then(function (data) {
        ...
        _this.setData({
          isLoading: false,
          isEmpty: _this.cartList.length === 0
        });
      });
    },
    // 计算总价和总数量
