...
var render = function () {
  ...
  var g0 = _vm.hotKeywords.length
  var g1 = !_vm.loading && !_vm.loadError ? _vm.newProducts.length : null
  var g2 = !_vm.loading && !_vm.loadError ? _vm.newProducts.length : null
...
var _default = {
  ...
  methods: {
    ...
    loadProducts: function loadProducts() {
      ...
      productApi.getNewProducts(6).then(function (news) {
    ...
    loadPageConfig: function loadPageConfig() {
      var _this3 = this;
      configApi.getAll().then(function (cfg) {
        cfg = cfg || {};
        var patch = {};
        if (cfg.service_phone) patch.servicePhone = cfg.service_phone;
        if (cfg.hot_keywords) {
          var kws = cfg.hot_keywords.split(',').map(function (s) {
            return s.trim();
          }).filter(Boolean);
    ...
    onTapBargain: function onTapBargain() {
      uni.navigateTo({
        url: '/pages/product/list?type=new&title=' + encodeURIComponent('捡漏专区')
      });
    },
    onTapHotList: function onTapHotList() {
      uni.navigateTo({
        url: '/pages/product/list?type=hot&title=' + encodeURIComponent('爆款推荐')
      });
    },
    onTapStore: function onTapStore() {
      this.setData({
        showStorePopup: true
      });
    },
