...
var _detail = _interopRequireDefault(__webpack_require__(/*! ./pages/order/detail.vue */ 144));
// @ts-ignore
...
/* harmony import */ var _detail_vue_vue_type_template_id_57d42baa___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./detail.vue?vue&type=template&id=57d42baa& */ 145);
...
/* harmony import */ var _detail_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./detail.vue?vue&type=style&index=0&lang=css& */ 149);
...
var _default = {
  ...
  methods: {
    ...
    copyOrderId: function copyOrderId() {
      var orderNo = this.orderInfo && this.orderInfo.order && this.orderInfo.order.orderNo || this.orderId;
    ...
    goToPay: function goToPay() {
      ...
      var amount = orderInfo && orderInfo.order && orderInfo.order.actualPayment || 0;
      uni.navigateTo({
        url: "/pages/order/payment?id=".concat(orderId, "&amount=").concat(amount)
      });
    },
    // 确认收货
